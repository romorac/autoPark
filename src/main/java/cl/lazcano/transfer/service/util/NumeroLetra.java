...
/**
 * <h1>LetraNum.java</h1><br>
 *
 * @author rmora
 * @since  21-10-2021
 *         <b>historial de cambios</b>
 *         <ul>
 *         <li>{0.0.0}[21-10-2021][rmora] inicial</li>
 *         </ul>
 **/
@Controller
public class NumeroLetra {
    ...
    public static void main(String[] args) {
        NumeroLetra letraNum = new NumeroLetra();
        Scanner num = new Scanner(System.in);
        String monto;
        try {
            monto = num.nextLine();
            String Convertir = letraNum.Convertir(monto, false);
    ...
    public String Convertir(String numero, boolean mayusculas) {
        ...
        if (Pattern.matches("\\d{1,9},\\d{1,2}", numero)) {
            ...
            return literal = "muy grande el numero";
        }
    }
